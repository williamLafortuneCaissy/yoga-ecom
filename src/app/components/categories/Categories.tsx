  ...
  return (
    <article className={styles.article}>
      <div className={styles.imgContainer}>
        <Image className={styles.img} src="./images/categories-1.jpg" alt="Women doing yoga with her toddler" width={750} height={500} />
...
function Article2() {
  return (
    <article className={styles.article}>
      <div className={styles.imgContainer}>
        <Image className={styles.img} src="./images/categories-2.jpg" alt="WOmen doing a complex yoga figure" width={900} height={900} />
...
function Article3() {
  return (
    <article className={styles.article}>
      ...
      <div className={styles.imgContainer}>
        <Image className={styles.img} src="./images/categories-3.jpg" alt="WOmen doing a complex yoga figure" width={880} height={501} />
        <div className={styles.btnContainer}>
          <InvertedCorner circleAt="top left" size="1.5rem" bottom="0" right="100%">
            <InvertedCorner circleAt="top left" size="1.5rem" bottom="100%" right="0">
              <span className={styles.spacer}>
